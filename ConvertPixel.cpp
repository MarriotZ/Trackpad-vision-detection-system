                          ...
                          unsigned char *pData, unsigned char *pDataSeparate)
{
	...
	GenImage3(Hobj, "byte", nWidth, nHeight, (Hlong)(dataRed), (Hlong)(dataGreen), (Hlong)(dataBlue));
 ...
 ************************************************************************/
Status HalconDisplay(HTuple *hWindow, const HObject &Hobj, const HTuple &hImageHeight,const HTuple &hImageWidth)
{
    if(NULL == hWindow)
    {
        return MV_E_PARAMETER;
    ...
    // ch: 显示 || en:display
    SetPart(*hWindow, 0, 0, hImageHeight - 1, hImageWidth - 1);
    DispObj(Hobj, *hWindow);
